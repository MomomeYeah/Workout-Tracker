...
type ThemedDropdownProps = DropdownProps<any> & {
    label?: string,
}
export default function ThemedDropdown({style, label, ...rest}: ThemedDropdownProps) {
    let theme = useTheme();
    ...
    return (
        <>
            {
                label && <ThemedText style={{fontSize: fontSizes.label}}>{label}</ThemedText>
            }
            <Dropdown
                style={[
                    {
